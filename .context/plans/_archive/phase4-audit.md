...
|-----------|-----|----------|--------------|--------|-------|
| **M0** | Foundation | [M0-foundation-types.md](M0-foundation-types.md) | `span_link.rs`, `scope_operator.rs`, `scope_index.rs`, `ambiguity.rs` | ✓ Verified | 36 tests, code review completed (2024-12-30) |
