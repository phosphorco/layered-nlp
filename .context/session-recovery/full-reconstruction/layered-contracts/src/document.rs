//! Document-level abstractions for multi-line contract processing.
//!
//! The core `layered-nlp` library operates on single lines (`LLLine`).
//! This module provides `ContractDocument` which wraps multiple lines
...
impl std::fmt::Debug for ContractDocument {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.debug_struct("ContractDocument")
